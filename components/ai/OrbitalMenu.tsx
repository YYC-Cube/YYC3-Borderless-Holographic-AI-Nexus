...
import { Grid, History, Keyboard, Settings, Users, X } from 'lucide-react';
...
export function OrbitalMenu({
  ...
  const menuItems: MenuItem[] = [
    { id: 'hub', icon: Grid, label: t('orbital.hub'), action: () => dispatch('hub', onOpenHub), color: 'bg-indigo-500' },
    { id: 'settings', icon: Settings, label: t('orbital.settings'), action: () => dispatch('config', onOpenSettings), color: 'bg-cyan-500' },
    { id: 'history', icon: History, label: t('orbital.history'), action: () => dispatch('history', onOpenHistory), color: 'bg-purple-500' },
    { id: 'debate', icon: Users, label: t('orbital.debate'), action: () => dispatch('debate', onOpenDebate), color: 'bg-pink-500' },
    { id: 'textmode', icon: Keyboard, label: t('orbital.textmode'), action: () => dispatch('textmode', onToggleTextMode), color: 'bg-emerald-500' },
  ];
